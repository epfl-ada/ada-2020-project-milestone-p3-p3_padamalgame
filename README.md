...
## Rendered notebook:
[**Click here**](https://nbviewer.jupyter.org/github/epfl-ada/ada-2020-project-milestone-p3-p3_padamalgame/blob/main/p4_extension.ipynb) to view the notebook rendered (map plots are not displayed), since GitHub does not support IPython rendering. To view the rendered notebook with all plots (including map plots), please download `p4_extension.html`. 
