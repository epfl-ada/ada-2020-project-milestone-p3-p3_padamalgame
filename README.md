...
## Rendered notebook:
To view the rendered notebook with all plotly plots, please download `p4_extension.ipynb`, as they will not show fully on GitHub (does not render IPython) but will locally. 
